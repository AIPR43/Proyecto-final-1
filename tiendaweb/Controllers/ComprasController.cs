...
namespace tiendaweb.Controllers
{
    public class ComprasController : Controller
    {
        ...
        {
            var tiendaContext = _context.Compras.Include(c => c.Proveedor);
        ...
        public async Task<IActionResult> Create([Bind("CompraId,ProveedorId,Fecha,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompraId,ProveedorId,Fecha,Total")] Compra compra)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tiendaContext.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
