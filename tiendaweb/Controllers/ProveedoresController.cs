    ...
    public class ProveedoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'tiendaContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("ProveedorId,Nombre,Dirección,Email,Teléfono")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProveedorId,Nombre,Dirección,Email,Teléfono")] Proveedore proveedore)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tiendaContext.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
